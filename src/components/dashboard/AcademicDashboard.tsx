                        ...
                        <div className="flex-1 w-full relative flex flex-col justify-end min-h-[140px] sm:min-h-[180px]">
                            {hasSeries ? (
                                <ResponsiveContainer width="100%" height="100%">
                                    <LineChart data={simulationResult?.time_series_pbpk || []} margin={{ top: 10, right: 10, left: 8, bottom: 8 }}>
                                        ...
                                        <XAxis
                                            ...
                                            height="auto"
                                        />
                                        <YAxis domain={[0, 'auto']} tick={{ fontSize: 11, fill: '#94a3b8' }} width="auto" tickMargin={2} />
