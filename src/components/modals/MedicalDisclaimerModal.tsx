    ...
    >
      ...
      >
        ...
        <div className="flex items-start gap-3 bg-slate-50 border border-slate-200 p-3.5 rounded-xl">
          ...
          />
          <label htmlFor="modal-disclaimer-consent" className="text-xs text-slate-700 font-medium leading-normal cursor-pointer select-none">
            Saya telah membaca, memahami, dan menyetujui batasan validitas <em>in-silico</em> HepaTwin ini.
          </label>
        </div>
